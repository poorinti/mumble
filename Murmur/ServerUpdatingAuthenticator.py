...
from Murmur.ServerAuthenticator import ServerAuthenticator
from Murmur.ServerAuthenticator import ServerAuthenticatorPrx

from Murmur.ServerUpdatingAuthenticator_forward import _Murmur_ServerUpdatingAuthenticatorPrx_t
...
class ServerUpdatingAuthenticatorPrx(ServerAuthenticatorPrx):
    ...
    Notes
    -----
        The Slice compiler generated this proxy class from Slice interface ``::Murmur::ServerUpdatingAuthenticator``.
    """
...
IcePy.defineProxy("::Murmur::ServerUpdatingAuthenticator", ServerUpdatingAuthenticatorPrx)
...
class ServerUpdatingAuthenticator(ServerAuthenticator, ABC):
    ...
    Notes
    -----
        The Slice compiler generated this skeleton class from Slice interface ``::Murmur::ServerUpdatingAuthenticator``.
    """

    _ice_ids: Sequence[str] = ("::Ice::Object", "::Murmur::ServerAuthenticator", "::Murmur::ServerUpdatingAuthenticator", )
...
__all__ = ["ServerUpdatingAuthenticator", "ServerUpdatingAuthenticatorPrx", "_Murmur_ServerUpdatingAuthenticatorPrx_t"]
