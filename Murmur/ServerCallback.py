...
from Murmur.TextMessage import _Murmur_TextMessage_t
...
if TYPE_CHECKING:
    ...
    from Murmur.TextMessage import TextMessage
...
class ServerCallbackPrx(ObjectPrx):
    ...
    Notes
    -----
        The Slice compiler generated this proxy class from Slice interface ``::Murmur::ServerCallback``.
    
    See Also
    --------
        :class:`Murmur.MetaCallbackPrx`
        ``Server.addCallback``
    """
...
IcePy.defineProxy("::Murmur::ServerCallback", ServerCallbackPrx)
...
class ServerCallback(Object, ABC):
    ...
    Notes
    -----
        The Slice compiler generated this skeleton class from Slice interface ``::Murmur::ServerCallback``.
    ...
    _ice_ids: Sequence[str] = ("::Ice::Object", "::Murmur::ServerCallback", )
...
ServerCallback._op_userTextMessage = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_User_t, False, 0), ((), _Murmur_TextMessage_t, False, 0)),
    (),
    None,
    ())
...
__all__ = ["ServerCallback", "ServerCallbackPrx", "_Murmur_ServerCallbackPrx_t"]
