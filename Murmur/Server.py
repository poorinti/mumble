...
from Murmur.ACLList import _Murmur_ACLList_t

from Murmur.BanList import _Murmur_BanList_t

from Murmur.CertificateList import _Murmur_CertificateList_t

from Murmur.Channel import _Murmur_Channel_t

from Murmur.ChannelMap import _Murmur_ChannelMap_t

from Murmur.ConfigMap import _Murmur_ConfigMap_t

from Murmur.GroupList import _Murmur_GroupList_t

from Murmur.IdList import _Murmur_IdList_t

from Murmur.IdMap import _Murmur_IdMap_t

from Murmur.InvalidCallbackException import _Murmur_InvalidCallbackException_t

from Murmur.InvalidChannelException import _Murmur_InvalidChannelException_t

from Murmur.InvalidInputDataException import _Murmur_InvalidInputDataException_t

from Murmur.InvalidSecretException import _Murmur_InvalidSecretException_t

from Murmur.InvalidSessionException import _Murmur_InvalidSessionException_t

from Murmur.InvalidTextureException import _Murmur_InvalidTextureException_t

from Murmur.InvalidUserException import _Murmur_InvalidUserException_t

from Murmur.LogList import _Murmur_LogList_t

from Murmur.NameList import _Murmur_NameList_t

from Murmur.NameMap import _Murmur_NameMap_t

from Murmur.NestingLimitException import _Murmur_NestingLimitException_t

from Murmur.ServerAuthenticator_forward import _Murmur_ServerAuthenticatorPrx_t

from Murmur.ServerBootedException import _Murmur_ServerBootedException_t

from Murmur.ServerCallback_forward import _Murmur_ServerCallbackPrx_t

from Murmur.ServerContextCallback_forward import _Murmur_ServerContextCallbackPrx_t

from Murmur.ServerFailureException import _Murmur_ServerFailureException_t
...
from Murmur.UserMap import _Murmur_UserMap_t

from Murmur.WriteOnlyException import _Murmur_WriteOnlyException_t
...
if TYPE_CHECKING:
    ...
    from Murmur.ACL import ACL
    from Murmur.Ban import Ban
    from Murmur.Channel import Channel
    from Murmur.Group import Group
    from Murmur.LogEntry import LogEntry
    from Murmur.ServerAuthenticator import ServerAuthenticatorPrx
    from Murmur.ServerCallback import ServerCallbackPrx
    from Murmur.ServerContextCallback import ServerContextCallbackPrx
    from Murmur.Tree import Tree
...
class ServerPrx(ObjectPrx):
    ...
    from one of the methods in :class:`Murmur.MetaPrx`.
    
    Notes
    -----
        The Slice compiler generated this proxy class from Slice interface ``::Murmur::Server``.
    """
    ...
    def addCallback(self, cb: ServerCallbackPrx | None, context: dict[str, str] | None = None) -> None:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.removeCallbackAsync`
        """
    ...
    def removeCallback(self, cb: ServerCallbackPrx | None, context: dict[str, str] | None = None) -> None:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.addCallbackAsync`
        """
    ...
    def setSuperuserPassword(self, pw: str, context: dict[str, str] | None = None) -> None:
        """
        Set superuser password. This is just a convenience for using :meth:`Murmur.ServerPrx.updateRegistrationAsync` on user id 0.
    ...
    def getUsers(self, context: dict[str, str] | None = None) -> dict[int, User]:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.getStateAsync`
        """
    ...
    def getChannels(self, context: dict[str, str] | None = None) -> dict[int, Channel]:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.getChannelStateAsync`
        """
    ...
    def setBans(self, bans: Sequence[Ban], context: dict[str, str] | None = None) -> None:
        """
        Set all current IP bans on the server. This will replace any bans already present, so if you want to add a ban, be sure to call :meth:`Murmur.ServerPrx.getBansAsync` and then
    ...
    def getState(self, session: int, context: dict[str, str] | None = None) -> User:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.setStateAsync`
            :meth:`Murmur.ServerPrx.getUsersAsync`
        """
    ...
    def sendMessage(self, session: int, text: str, context: dict[str, str] | None = None) -> None:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.sendMessageChannelAsync`
        """
    ...
    def addContextCallback(self, session: int, action: str, text: str, cb: ServerContextCallbackPrx | None, ctx: int, context: dict[str, str] | None = None) -> None:
        ...
        cb : ServerContextCallbackPrx | None
            Callback interface which will receive notifications.
        ctx : int
            Context this should be used in. Needs to be one or a combination of :class:`Murmur.ContextServer`, :class:`Murmur.ContextChannel` and :class:`Murmur.ContextUser`.
        context : dict[str, str]
            The request context for the invocation.
        
        See Also
        --------
            :meth:`Murmur.ServerPrx.removeContextCallbackAsync`
        """
    ...
    def removeContextCallback(self, cb: ServerContextCallbackPrx | None, context: dict[str, str] | None = None) -> None:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.addContextCallbackAsync`
        """
    ...
    def getChannelState(self, channelid: int, context: dict[str, str] | None = None) -> Channel:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.setChannelStateAsync`
            :meth:`Murmur.ServerPrx.getChannelsAsync`
        """
    ...
    def sendMessageChannel(self, channelid: int, tree: bool, text: str, context: dict[str, str] | None = None) -> None:
        ...
        See Also
        --------
            :meth:`Murmur.ServerPrx.sendMessageAsync`
        """
...
IcePy.defineProxy("::Murmur::Server", ServerPrx)
...
class Server(Object, ABC):
    ...
    Notes
    -----
        The Slice compiler generated this skeleton class from Slice interface ``::Murmur::Server``.
    """

    _ice_ids: Sequence[str] = ("::Ice::Object", "::Murmur::Server", )
...
Server._op_start = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_ServerFailureException_t, _Murmur_InvalidSecretException_t))
...
Server._op_stop = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSecretException_t))
...
Server._op_addCallback = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_ServerCallbackPrx_t, False, 0),),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidCallbackException_t, _Murmur_InvalidSecretException_t))
...
Server._op_setAuthenticator = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_ServerAuthenticatorPrx_t, False, 0),),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidCallbackException_t, _Murmur_InvalidSecretException_t))
...
Server._op_getConf = IcePy.Operation(
    ...
    (),
    ((), IcePy._t_string, False, 0),
    (_Murmur_InvalidSecretException_t, _Murmur_WriteOnlyException_t))
...
Server._op_getCertificateList = IcePy.Operation(
    ...
    (((), IcePy._t_int, False, 0),),
    (),
    ((), _Murmur_CertificateList_t, False, 0),
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSessionException_t, _Murmur_InvalidSecretException_t))
...
Server._op_setState = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSessionException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSecretException_t))
...
Server._op_addContextCallback = IcePy.Operation(
    ...
    None,
    (),
    (((), IcePy._t_int, False, 0), ((), IcePy._t_string, False, 0), ((), IcePy._t_string, False, 0), ((), _Murmur_ServerContextCallbackPrx_t, False, 0), ((), IcePy._t_int, False, 0)),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidCallbackException_t, _Murmur_InvalidSecretException_t))
...
Server._op_removeContextCallback = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_ServerContextCallbackPrx_t, False, 0),),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidCallbackException_t, _Murmur_InvalidSecretException_t))
...
Server._op_getChannelState = IcePy.Operation(
    ...
    (((), IcePy._t_int, False, 0),),
    (),
    ((), _Murmur_Channel_t, False, 0),
    (_Murmur_ServerBootedException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSecretException_t))
...
Server._op_setChannelState = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSecretException_t, _Murmur_NestingLimitException_t))
...
Server._op_getACL = IcePy.Operation(
    ...
    (),
    (((), IcePy._t_int, False, 0),),
    (((), _Murmur_ACLList_t, False, 0), ((), _Murmur_GroupList_t, False, 0), ((), IcePy._t_bool, False, 0)),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSecretException_t))
...
Server._op_setACL = IcePy.Operation(
    ...
    None,
    (),
    (((), IcePy._t_int, False, 0), ((), _Murmur_ACLList_t, False, 0), ((), _Murmur_GroupList_t, False, 0), ((), IcePy._t_bool, False, 0)),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSecretException_t))
...
Server._op_addUserToGroup = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidChannelException_t, _Murmur_InvalidSessionException_t, _Murmur_InvalidSecretException_t))
...
Server._op_getUserNames = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_IdList_t, False, 0),),
    (),
    ((), _Murmur_NameMap_t, False, 0),
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSecretException_t))
...
Server._op_getUserIds = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_NameList_t, False, 0),),
    (),
    ((), _Murmur_IdMap_t, False, 0),
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSecretException_t))
...
Server._op_registerUser = IcePy.Operation(
    ...
    (),
    ((), IcePy._t_int, False, 0),
    (_Murmur_ServerBootedException_t, _Murmur_InvalidUserException_t, _Murmur_InvalidSecretException_t))
...
Server._op_updateRegistration = IcePy.Operation(
    ...
    None,
    (),
    (((), IcePy._t_int, False, 0), ((), _Murmur_UserInfoMap_t, False, 0)),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidUserException_t, _Murmur_InvalidSecretException_t))
...
Server._op_setTexture = IcePy.Operation(
    ...
    None,
    (),
    (((), IcePy._t_int, False, 0), ((), _Murmur_Texture_t, False, 0)),
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidUserException_t, _Murmur_InvalidTextureException_t, _Murmur_InvalidSecretException_t))
...
Server._op_updateCertificate = IcePy.Operation(
    ...
    (),
    None,
    (_Murmur_ServerBootedException_t, _Murmur_InvalidSecretException_t, _Murmur_InvalidInputDataException_t))

__all__ = ["Server", "ServerPrx", "_Murmur_ServerPrx_t"]
