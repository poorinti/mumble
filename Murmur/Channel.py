...
class Channel:
    ...
    Notes
    -----
        The Slice compiler generated this dataclass from Slice struct ``::Murmur::Channel``.
    """
    id: int = 0
    name: str = ""
    parent: int = 0
...
_Murmur_Channel_t = IcePy.defineStruct(
    "::Murmur::Channel",
    Channel,
    (),
    (
