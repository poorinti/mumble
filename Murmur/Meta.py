...
from Murmur.Meta_forward import _Murmur_MetaPrx_t

from Murmur.ServerList import _Murmur_ServerList_t
...
if TYPE_CHECKING:
    ...
    from Murmur.MetaCallback import MetaCallbackPrx
...
class MetaPrx(ObjectPrx):
    """
    This is the meta interface. It is primarily used for retrieving the :class:`Murmur.ServerPrx` interfaces for each individual server.
    
    Notes
    -----
        The Slice compiler generated this proxy class from Slice interface ``::Murmur::Meta``.
    """
...
IcePy.defineProxy("::Murmur::Meta", MetaPrx)
...
class Meta(Object, ABC):
    ...
    Notes
    -----
        The Slice compiler generated this skeleton class from Slice interface ``::Murmur::Meta``.
    """

    _ice_ids: Sequence[str] = ("::Ice::Object", "::Murmur::Meta", )
...
Meta._op_addCallback = IcePy.Operation(
    ...
    None,
    (),
    (((), _Murmur_MetaCallbackPrx_t, False, 0),),
    (),
    None,
    (_Murmur_InvalidCallbackException_t, _Murmur_InvalidSecretException_t))
...
__all__ = ["Meta", "MetaPrx", "_Murmur_MetaPrx_t"]
