...
class Group:
    ...
    Notes
    -----
        The Slice compiler generated this dataclass from Slice struct ``::Murmur::Group``.
    """
    name: str = ""
...
_Murmur_Group_t = IcePy.defineStruct(
    "::Murmur::Group",
    Group,
    (),
    (
        ...
        ("add", (), _Murmur_IntList_t),
        ("remove", (), _Murmur_IntList_t),
        ("members", (), _Murmur_IntList_t)
    ))

__all__ = ["Group", "_Murmur_Group_t"]
